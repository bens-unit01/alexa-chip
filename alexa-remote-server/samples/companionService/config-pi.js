...
clientId: "amzn1.application-oa2-client.71a603166b4b4c30aa35e6809a59a232",
	  clientSecret:
		  "469170eaaa983f2518d2443d424e87fff54ee0bb9cef27362cf0a032cb10bd1f",
	  redirectUrl: 'https://localhost:3000/authresponse',
	  lwaRedirectHost: "amazon.com",
	  lwaApiHost: "api.amazon.com",
	  validateCertChain: true,
	  sslKey:
		  "/home/pi/alexa-tests/alexa-avs-sample-app-raspberry-pi/samples/javaclient/certs/server/node.key",
	  sslCert:
		  "/home/pi/alexa-tests/alexa-avs-sample-app-raspberry-pi/samples/javaclient/certs/server/node.crt",
	  sslCaCert:
		  "/home/pi/alexa-tests/alexa-avs-sample-app-raspberry-pi/samples/javaclient/certs/ca/ca.crt",
	  products: {
		  "wow_robot_01": ["1xxxxxxxxxx"],
	  },
};
