...
//    private static final String TestTopic = "sdk/test/java";
    private static final String TestTopic = "waterPump/kitchen/";
    ...
    public static void test(String args[]) throws InterruptedException, AWSIotException, AWSIotTimeoutException {
